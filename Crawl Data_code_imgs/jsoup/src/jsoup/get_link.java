...
public class get_link {
	public static void main(String[] args) throws Exception {
		String html = get_html
				.getHtmlByUrl("http://urochester.bncollege.com/webapp/wcs/stores/servlet/SubcategoryView?parentCatId=40360&level=2&categoryId=40403&catalogId=10001&langId=-1&storeId=27055&topCatId=40000");
		if (html != null && !"".equals(html)) {
			...
			for (Element item : items) {
				...
				for (Element img : imgs) {
					...
					String category = "Apparel\\Men\\ACCESSORIES\\";
					// save file
					String path = "C:\\Users\\Administrator\\Desktop\\workplace\\"+category;
					String filename = "ACCESSORIES" + Integer.toString(x) + ".jpg";
